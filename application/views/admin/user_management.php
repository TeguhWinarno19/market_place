        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-6 text-right">
                    <a href="<?= base_url('admin/cetak_user_management'); ?>" class="btn btn-primary mb-3"><i class="fas fa-print"></i> </a>
                    <a href="<?= base_url('admin/excel_user_management'); ?>" class="btn btn-success mb-3"><i class="far fa-file-excel"></i> </a>
                </div>
            </div>
            <hr>
