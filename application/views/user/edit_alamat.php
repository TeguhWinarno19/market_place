            ...
            <div class="shadow p-1">
                ...
                <div class="row mb-5">
                    ...
                    <div class="col col-lg-7 col-md-7 col-sm-12 col-12">
                        ...
                        <form class="user m-1" method="post" action="<?= base_url('dashboard/update_alamat'); ?>">
                            <div class="form-group">
                                ...
                                value ="<?php echo $a->nama_penerima ?>">
                                <input type="hidden" name="id_alamat" class="form-control" value="<?php echo $a->id_alamat ?>">
                                <input type="hidden" name="id_user" class="form-control" value="<?php echo $a->id_user ?>">
